...
Vemos que con el cambio tenemos en el dataset variables de tipo numéricas y categóricas o factor
...
Reproducimos la matriz de confusión y las métricas de evaluación sobre el modelo final de ADABoost obtenido:
...
Realizando la comprobación del modelo con los datos de test al final del análisis, se comprueba que es un modelo generalizables, robustos y con resultados relativamente similares tanto en train como en test, siendo esto un resultado final del trabajo positivo.
