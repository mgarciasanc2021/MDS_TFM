...
En este apartado se analizan diferentes algoritmos supervisados (con datos etiquetados para su predicción o clasificación) sobre nuestro conjunto de datos sobre créditos bancarios.

## 7.1. GLM - Generalized Lineal Model

### 7.1.1. Variable de interés y análisis de relaciones entre variables
...
### 7.1.2. Creación del modelo de Regresión Logística
...
### 7.1.3. GLM - Cross Validation, Hiperparámetros y Evaluación del modelo
...
### 7.2.1. DECISION TREE - Cross Validation, Hiperparámetros y Evaluación del modelo
...
### 7.3.1. RANDOM FOREST - Cross Validation, Hiperparámetros y Evaluación del modelo
