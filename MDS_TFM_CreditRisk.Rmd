---
title: "TFM: Riesgo de crédito - Análisis, desarrollo y código"
...
* **Variable cb_person_default_on_file en función de las variables loan_int_rate y loan_percent_income:**
...
Como se puede observar, en el caso del modelo de Random Forest, las variables que mayor relavancia parecen tener en la definición de la capacidad predictora del mismo son "loan_percent_income", "loan_grade", "person_home_ownership", "person_income" y "loan_intent".
...
RocImp_xgb <- varImp(caret.xgb, scale = FALSE)

plot(RocImp_xgb)

```  

Como se puede observar, para el modelo de XGBoost las variables que mayor relevancia tienen a la hora de crear el algoritmo para la predicción del riesgo de impago son "loan_percent_income", "person_income", "loan_int_rate", "person_home_ownership" en el caso de "Rent" o alquiler, y "loan_grade" en caso de clientes y operaciones con Scoring "D".
